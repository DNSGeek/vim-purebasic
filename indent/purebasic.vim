...
setlocal indentkeys+=,=~EndImport,=~CompilerEndIf,=~CompilerElseIf,=~CompilerElse
setlocal indentkeys+=,=~CompilerEndSelect,=~CompilerCase,=~CompilerDefault
